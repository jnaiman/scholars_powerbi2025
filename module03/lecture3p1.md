---
title: Lecture 3.1 - PowerBI Intro
layout: lecture
tags: 
  - overview
  - powerbi
...
<img src="images/powerbi/checkpowerbiaccess.png" style='border:1px solid #000000' alt="A picture of the 'Online PowerBI Version' link on the Syllabus.  Same link as text below.">
...
<img src="images/powerbi/walkthrough1link.png" style='border:1px solid #000000' alt="Image of the link on course webpage to the 'PowerBI Walkthrough #1'. Same link as text above.">

notes:
further instructions are linked in our first walkthrough which we will start right after this lecture

you can either use the PDF or HTML page -- pros and cons to each

The PDF has nicer formatting for text that is next to images **show this**

The HTML page can be used with Google translate into another language

The first bit you'll see in walkthrough 1, in brief...
...
## Changing the language on PowerBI

<img src="images/powerbi/selectlanguage1.png" width="90%" style='border:1px solid #000000' alt="Click on the 'gear' symbol and then on 'General' tab">
...
<img src="images/powerbi/selectlanguage2.png" width="90%" style='border:1px solid #000000' alt="Click on the 'select language' button to select the language">
